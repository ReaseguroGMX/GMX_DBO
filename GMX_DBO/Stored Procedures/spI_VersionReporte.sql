...
SELECT @cod_config = ISNULL(MAX(cod_config),0) + 1 FROM aCRH_ConfigReportes

INSERT INTO aCRH_ConfigReportes VALUES(@cod_config,@cod_reporte,@cod_usuario,@descripcion,@filtros,@formato,GETDATE(),@sn_Temporal)
